...
tags:
  ...
  - Swift
private: false
updated_at: '2023-05-30T09:42:38+09:00'
id: 0dd01dba4a44f07f7e14
organization_url_name: null
slide: false
---
# 記事の背景
先日、APIにリクエストを投げる際、`Int?`型にnilを入れて投げたところ、うまく反映されないという問
題にぶち当たった。
...
# 原因の考察
[Apple、FoundationフレームワークのGitHubのとあるIssue](https://github.com/apple/swift-corelibs-foundation/issues/3594)によると、

1. `nil`を`Null`でエンコードするオプションは`encode(to:)`で自分で書くことができるから、Swiftやフレームワークが用意する必要性はない
1. Nullと欠落を同一視するAPIが多いため
1. ペイロードは小さい方が良いから
